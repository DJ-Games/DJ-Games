        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            switch (gamestate)
            {
                ...
                case Gamestate.DELVING:
                    ...
                    spriteBatch.DrawString(dungeonFont, "You have completed area " + player.DungeonArea + "!", new Vector2(685, 200), Color.White);
                ...
                case Gamestate.GAME_OVER:
                    ...
                    spriteBatch.Draw(titleBlack, new Vector2(0, 0), new Rectangle?(), Color.White, 0f, new Vector2(), 1f, SpriteEffects.None, 1);
                    spriteBatch.DrawString(dungeonFont, "You died. Game Over.", new Vector2(685, 200), Color.White);
                ...
                case Gamestate.WINSCREEN:
                    ...
                    spriteBatch.Draw(titleBlack, new Vector2(0, 0), new Rectangle?(), Color.White, 0f, new Vector2(), 1f, SpriteEffects.None, 1);
                    spriteBatch.DrawString(dungeonFont, "You win!", new Vector2(700, 200), Color.White);
