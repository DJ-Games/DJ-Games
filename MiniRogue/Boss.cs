        ...
        public override void DrawCard(SpriteBatch sBatch, SpriteFont dungeonFont)
        {
            ...
            switch (bossTurnState)
            {
                ...
                case BossTurnState.REWARDS:
                    ...
                    sBatch.DrawString(dungeonFont, "Roll to determine your reward.", new Vector2(615, 230), Color.White);
                ...
                case BossTurnState.REMOVESPELL:
                    ...
                    sBatch.DrawString(dungeonFont, "Click a spell to remove or", new Vector2(650, 250), Color.White, 0f, new Vector2(), 1f, SpriteEffects.None, 0f);
                    sBatch.DrawString(dungeonFont, "click done to keep current spells", new Vector2(600, 300), Color.White, 0f, new Vector2(), 1f, SpriteEffects.None, 0f);
