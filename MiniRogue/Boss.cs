...
namespace MiniRogue
{
    ...
    class Boss : Enemy
    {
        ...
        public Boss(string name, Texture2D cardTexture, Dictionary<string, Button> buttons, Dictionary<string, CombatDice> combatDice, Dictionary<string, CheckBox> checkBoxes) : base(name, cardTexture, buttons)
        {
            Buttons = buttons;
